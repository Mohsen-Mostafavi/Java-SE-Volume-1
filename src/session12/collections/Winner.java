...
public class Winner {
    ...
    public static final List<Winner> tdfWinners = Arrays.asList(
            ...
            new Winner(2006, "Spain", "?scar Pereiro", "Caisse d'Epargne�Illes Balears", 3657, Duration.parse("PT89H40M27S"), 8),
    ...
    public static void main(String args[]) {
        ...
        // Winners of Tours Greater than 3500km - [?scar Pereiro, Alberto Contador, Carlos Sastre, Andy Schleck, Vincenzo Nibali, Chris Froome]
        ...
        // mapWinnerYearNamesToList [2006 - ?scar Pereiro, 2007 - Alberto Contador, 2008 - Carlos Sastre, 2009 - Alberto Contador, 2010 - Andy Schleck, 2011 - Cadel Evans, 2012 - Bradley Wiggins, 2013 - Chris Froome, 2014 - Vincenzo Nibali, 2015 - Chris Froome, 2016 - Chris Froome]
        ...
        // namesVsWinner - {Bradley Wiggins=[Bradley Wiggins], Carlos Sastre=[Carlos Sastre], Cadel Evans=[Cadel Evans], ?scar Pereiro=[?scar Pereiro], Chris Froome=[Chris Froome, Chris Froome, Chris Froome], Andy Schleck=[Andy Schleck], Alberto Contador=[Alberto Contador, Alberto Contador], Vincenzo Nibali=[Vincenzo Nibali]}
        ...
        // winnersByNationality - {Great Britain=[Bradley Wiggins, Chris Froome, Chris Froome, Chris Froome], Luxembourg=[Andy Schleck], Italy=[Vincenzo Nibali], Australia=[Cadel Evans], Spain=[?scar Pereiro, Alberto Contador, Carlos Sastre, Alberto Contador]}
